...
import { TextAnimate } from "@/components/atoms/magicui/animations/text-animate";
              ...
              >
                ...
                >
                  <badge.icon 
                    ...
                    aria-hidden="true"
                  />                  <TextAnimate className={`font-medium text-sm lg:text-base ${badge.textColor} whitespace-nowrap`} words={badge.text} />
                </div>
