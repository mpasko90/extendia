...
import { Card, CardContent } from '@/components/atoms/ui';
import { Star, Award, Shield, ThumbsUp, Users, BadgeCheck } from 'lucide-react';
...
const trustSignals: TrustSignal[] = [
  ...
  {
    icon: <BadgeCheck className="h-8 w-8 text-accent-orange" />,
    label: 'Experience',
    value: '15+ Years'
  },
  {
